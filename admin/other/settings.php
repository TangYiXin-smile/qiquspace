    ...
    <div class="container-fluid">
      ...
      <form class="form-horizontal" action="modifyset.php" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <div class="checkbox">
              <?php if($conf['site_cmts']==1):?>
                <label><input id="comment_status" name="comment_status" value=1 type="checkbox" checked>开启评论功能</label>
              <?php else:?>
                <label><input id="comment_status" name="comment_status" value=1 type="checkbox">开启评论功能</label>
              <?php endif;?>
            </div>
            <div class="checkbox">
              <?php if($conf['site_allow']==1):?>
                <label><input id="comment_reviewed" name="comment_reviewed" value=1 type="checkbox" checked>评论必须经人工批准</label>
              <?php else:?>
                <label><input id="comment_reviewed" name="comment_reviewed" value=1 type="checkbox">评论必须经人工批准</label>
              <?php endif;?>
            </div>
          </div>
        </div>
